...
export const matrizDB: Mascaras[] = [
  {
    ...
    descricao:
      'O.S gerada quando não for possivel executar o cancelamento em função de algum tipo de erro apresentado pelo SINN.',
    opcao:
      'Quando o cliente solicitar cancelamento e no momento da execução o sistema apresentar mensagens de erro que impossibilite o cancelamento ',
    mascara:
      'Cliente solicita cancelamento do serviço de TV. Não executado no SINN devido indisponibilidade da ferramenta. Ocorreu o erro: (GRATUIDADE APLICADA)',
    area: 'B.O',
    prazo: '48 Horas'
  },
  {
    ...
    mascara:
      'Cliente desconhece contrato e solicita cancelamento. Orientado que a área responsável dará o devido tratamento e entrará em contato com uma posição.',
    area: 'Área de Fraude',
    prazo: 'Em até 7 dias'
  },
  {
    ...
    descricao:
      'Solicitação de aplicação de desconto na fatura de cliente que está no cenário: Desconhece migração para Pacote Pago',
  ...
  },
  {
    ...
    mascara:
      'Contrato com flag de Fraude, cliente solicita cancelamento. Orientado que a área responsável dará o devido tratamento e entrará em contato com uma posição.',
    area: 'Área de Fraude',
    prazo: '5 dias úteis'
  },
  {
    ...
    descricao:
      'O.S gerada para solicitar a disponibilização da gravação de determinado atendimento na minha Oi.',
    opcao:
      'Quando o cliente solicitar a gravação para confirmação de algum atendimento.',
    mascara: `
  ...
  },
  {
    ...
    descricao:
      'O.S gerada quando não for possivel executar a instalação de uma oferta ou serviço em função de algum tipo de erro apresentado pelo SINN.',
  ...
  },
  {
    ...
    descricao:
      'Cenários onde é possível solicitar prioridade técnica para o reparo.',
